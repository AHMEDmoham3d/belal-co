const defaultPlayersData = {
  ...
  'farah013': { name: 'فرح عادل', points: 33, absences: 0, rank: 6, password: 'farah013' },
  'remas009': { name: 'ريماس طارق', points: 33, absences: 0, rank: 7, password: 'remas009' },
  'nada014': { name: 'ندى أنور', points: 32, absences: 0, rank: 8, password: 'nada014' },
  'nelly018': { name: 'نيللي محمود', points: 32, absences: 0, rank: 9, password: 'nelly018' },
  'Basma0026': { name: 'بسمه اشرف ', points: 32, absences: 0, rank: 10, password: 'Basma0026' },
  'iten011': { name: 'إيتن فتحي', points: 30, absences: 0, rank: 11, password: 'iten011' },
  ...
  'malak008': { name: 'ملك أيمن', points: -1, absences: 0, rank: 21, password: 'malak008' },
  'retag006': { name: 'ريتاج محمود', points: -1, absences: 1, rank: 22, password: 'retag006' },
  'judy007': { name: 'جودي محمود', points: -1, absences: 1, rank: 23, password: 'judy007' },
  'Hanen787': { name: 'حنين شوقى', points: -1, absences: 0, rank: 24, password: 'Hanen787' },
  'Elsaed025': { name: 'السيد امام', points: -1, absences: 0, rank: 25, password: 'Elsaed025' },
  'Malak0270': { name: 'ملك احمد', points: -1, absences: 0, rank: 26, password: 'Malak0270' },
  'retag004': { name: 'ريتاج أحمد', points: 0, absences: 1, rank: 27, password: 'retag004' },
  'rodina017': { name: 'رودينا إسلام', points: -2, absences: 2, rank: 28, password: 'rodina017' },

const defaultPlayersData = {
  'mohamedsaid021': { name: 'محمد سعيد', points: 38, absences: 0, rank: 1, password: 'mohamedsaid021' },
  'mohamed012': { name: 'محمد عبد التام', points: 37, absences: 0, rank: 2, password: 'mohamed012' },
  'taha019': { name: 'طه إسلام طه', points: 36, absences: 0, rank: 3, password: 'taha019' },
  'sama016': { name: 'سما وليد', points: 35, absences: 0, rank: 4, password: 'sama016' },
  'adam002': { name: 'آدم هاني', points: 34, absences: 0, rank: 5, password: 'adam002' },
  'iten011': { name: 'إيتن فتحي', points: 33, absences: 0, rank: 6, password: 'iten011' },
  'farah013': { name: 'فرح عادل', points: 33, absences: 0, rank: 7, password: 'farah013' },
  'remas009': { name: 'ريماس طارق', points: 33, absences: 0, rank: 8, password: 'remas009' },
  'nada014': { name: 'ندى أنور', points: 32, absences: 0, rank: 9, password: 'nada014' },
  'nelly018': { name: 'نيللي محمود', points: 32, absences: 0, rank: 10, password: 'nelly018' },
  'Basma0026': { name: 'بسمه اشرف ', points: 32, absences: 0, rank: 11, password: 'Basma0026' },
  'Afnan022': { name: 'أفنان عادل', points: 30, absences: 0, rank: 12, password: 'Afnan022' },
  'yasen000': { name: 'ياسين احمد', points: 30, absences: 0, rank: 13, password: 'yasen000' },
  'login001': { name: 'لوجين أحمد', points: 29, absences: 0, rank: 14, password: 'login001' },
  'ahmed003': { name: 'أحمد عطية', points: 29, absences: 1, rank: 15, password: 'ahmed003' },
  'omar005': { name: 'عمر عادل', points: 28, absences: 0, rank: 16, password: 'omar005' },
  'adel020': { name: 'عادل صبري', points: 27, absences: 0, rank: 17, password: 'adel020' },
  'noreen015': { name: 'نورين محمود', points: 26, absences: 0, rank: 18, password: 'noreen015' },
  'malak010': { name: 'ملك محمود السيد', points: 25, absences: 0, rank: 19, password: 'malak010' },
  'Adam0028': { name: 'ادم عمرو', points: 25, absences: 1, rank: 20, password: 'Adam0028' },
  'rodina017': { name: 'رودينا إسلام', points: 9, absences: 2, rank: 21, password: 'rodina017' },
  'retag004': { name: 'ريتاج أحمد', points: 0, absences: 1, rank: 22, password: 'retag004' },
  'Belal': { name: 'بلال محمد', points: 0, absences: 0, rank: 23, isAdmin: true, password: 'Belal' },
  'malak008': { name: 'ملك أيمن', points: -1, absences: 0, rank: 24, password: 'malak008' },
  'retag006': { name: 'ريتاج محمود', points: -1, absences: 1, rank: 25, password: 'retag006' },
  'judy007': { name: 'جودي محمود', points: -1, absences: 1, rank: 26, password: 'judy007' },
  'Hanen787': { name: 'حنين شوقى', points: -1, absences: 0, rank: 27, password: 'Hanen787' },
  'Elsaed025': { name: 'السيد امام', points: -1, absences: 0, rank: 28, password: 'Elsaed025' },
  'Malak0270': { name: 'ملك احمد', points: -1, absences: 0, rank: 29, password: 'Malak0270' }

const defaultPlayersData = {
  ...
  'omar005': { name: 'عمر عادل', points: 28, absences: 0, rank: 5, password: 'omar005' },
  ...
  'malak008': { name: 'ملك أيمن', points: -1, absences: 0, rank: 8, password: 'malak008' },
  'remas009': { name: 'ريماس طارق', points: 32, absences: 0, rank: 9, password: 'remas009' },
  'malak010': { name: 'ملك محمود السيد', points: 25, absences: 0, rank: 10, password: 'malak010' },
  'iten011': { name: 'إيتن فتحي', points: 30, absences: 0, rank: 11, password: 'iten011' },
  'mohamed012': { name: 'محمد عبد التام', points: 36, absences: 0, rank: 12, password: 'mohamed012' },
  'farah013': { name: 'فرح عادل', points: 32, absences: 0, rank: 13, password: 'farah013' },
  'nada014': { name: 'ندى أنور', points: 32, absences: 0, rank: 14, password: 'nada014' },
  'noreen015': { name: 'نورين محمود', points: 26, absences: 0, rank: 15, password: 'noreen015' },
  'sama016': { name: 'سما وليد', points: 34, absences: 0, rank: 16, password: 'sama016' },
  'rodina017': { name: 'رودينا إسلام', points: -2, absences: 2, rank: 17, password: 'rodina017' },
  'nelly018': { name: 'نيللي محمود', points: 32, absences: 0, rank: 18, password: 'nelly018' },
  'taha019': { name: 'طه إسلام طه', points: 36, absences: 0, rank: 19, password: 'taha019' },
  'adel020': { name: 'عادل صبري', points: 27, absences: 0, rank: 20, password: 'adel020' },
  'mohamedsaid021': { name: 'محمد سعيد', points: 38, absences: 0, rank: 21, password: 'mohamedsaid021' },
  'Afnan022': { name: 'أفنان عادل', points: 30, absences: 0, rank: 22, password: 'Afnan022' },
  'yasen000': { name: 'ياسين احمد', points: 30, absences: 0, rank: 23, password: 'yasen000' },
  ...
  'Basma0026': { name: 'بسمه اشرف ', points: 32, absences: 0, rank: 26, password: 'Basma0026' },
  'Malak0270': { name: 'ملك احمد', points: -1, absences: 0, rank: 27, password: 'Malak0270' },
  'Adam0028': { name: 'ادم عمرو', points: 25, absences: 1, rank: 28, password: 'Adam0028' },
